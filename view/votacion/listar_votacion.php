...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="../nominado/listar_nominado.php"><i class="icon-user12 icon"></i><span>Nominados</span></a></li>
			<li><a href="#"><i class="icon-bar-chart-2 icon"></i><span>Votacion</span></a></li>
	...
	<section id="content">
		...
		<!-- MAIN -->
		<main>
			<h1 class="title">Listar Votación <a href="crear_votacion.php" i class=" icon-file-add icon" id="crear"></a></h1>
			<ul class="breadcrumbs">
				<li><a href="#">Inicio</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Votación</a></li>
			</ul>
			<div class="info-data">
				<div class="card">
					<div class="head">
